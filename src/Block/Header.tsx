  ...
  return (
    <div className="border-b h-[70px] justify-center flex items-center w-full relative">
      <div className="w- h-[50px] justify-between flex items-center w-[95%] bg-blue-950]">
        <div className="justify-center items-center flex rounded-[50%] shadow-md bg-blue-900 text-[white]  font-[700]">
          <img src={img} alt="" className="h-[60px]" />
        </div>
        <div className="w-[200px] flex justify-center items-center">
          <button className="mr-[10px] hidden xl:block font-[700] border p-2 rounded-md bg-blue-900 text-white sm:none">
            Signin
          </button>
          <button className="hidden xl:block font-[700] border p-2 rounded-md bg-blue-900 text-white sm:none">
            Register
          </button>
        </div>
        {toggle ? (
